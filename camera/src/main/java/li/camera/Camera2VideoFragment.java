...
public class Camera2VideoFragment extends Fragment
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.record_camera2_video, container, false);
    }
            ...
            mCameraDevice.createCaptureSession(surfaces, new CameraCaptureSession.StateCallback() {
                ...
                public void onConfigured(@NonNull CameraCaptureSession cameraCaptureSession) {
                    ...
                    getActivity().runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            // UI
                            mButtonVideo.setImageResource(R.drawable.ic_pause_circle_outline_black_24dp);
    ...
    private void stopRecordingVideo() {
        ...
        mButtonVideo.setImageResource(R.drawable.ic_brightness_1_black_24dp);
        // Stop recording
        mMediaRecorder.stop();
